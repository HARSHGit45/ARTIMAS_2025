...
const FoldableMap = () => {
  ...
  return (
    ...
    <div className="relative h-[70vh] md:h-[90vh] 2xl:h-[102vh] flex flex-col items-center">
      ...
      {!isFolded && (
        <>
          <motion.div className="absolute top-72 sm:top-24 md:top-118 lg:top-96 xl:top-40 left-12 sm:left-16 md:left-22 lg:left-34 xl:left-83 2xl:top-60 2xl:left-90 rotate-x-0 rotate-y-8" initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1, transition: { delay: 0.2 } }}>
            <EventCard title="HackMatrix" />
          </motion.div>
          <motion.div className="absolute top-77 sm:top-48 md:top-130 lg:top-114 xl:top-59 left-40 sm:left-44 md:left-82 lg:left-120 xl:left-149 2xl:top-79 2xl:left-169 -rotate-x-12 rotate-y-8" initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1, transition: { delay: 0.4 } }}>
            <EventCard title="Datathon" />
          </motion.div>
          <motion.div className="absolute top-86 sm:top-64 md:top-146 md:left-40 lg:top-133 lg:left-55 xl:top-76 left-20 2xl:top-98 2xl:left-100 rotate-x-0 rotate-y-8" initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1, transition: { delay: 0.6 } }}>
            <EventCard title="Among Us" />
          </motion.div>
          <motion.div className="absolute top-70 sm:top-72 md:top-145 lg:top-128 xl:top-[150px] right-9 sm:right-24 md:right-36 lg:right-44 xl:right-64 2xl:top-60 2xl:right-98 rotate-x-0 rotate-y-12" initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1, transition: { delay: 0.8 } }}>
